...
const Services = () => {
  return (
    <div className="p-6 md:p-10 mt-10">
      <h2 className="text-3xl font-bold text-center text-customBlue mb-8">Our Top Notch Services</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {servicesData.map((service, index) => (
          <div key={index} className="bg-white p-6 shadow-lg rounded-lg text-center hover:shadow-xl transition-shadow duration-300">
            <div className="flex justify-center items-center text-customBlue text-5xl mb-4">
              <service.icon />
            </div>
