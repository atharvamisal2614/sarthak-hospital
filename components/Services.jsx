...
const Services = () => {
  return (
    <div className="p-6 md:p-10 mt-10">
      <h2 className="text-3xl font-bold text-center text-blue-500 mb-8">Best Hospital Services In Town <br/>
</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {servicesData.map((service, index) => (
          <div key={index} className="bg-white p-6 shadow-lg rounded-lg text-center hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-semibold mb-3 text-green-800">{service.name}</h3>
