...
const Navbar = () => {
  ...
  return (
    <nav className="relative z-20"> {/* Added z-20 to navbar */}
      <div className=" mx-auto px-4 sm:px-6 lg:px-8 lg:mt-5 md:mb-5 mb-4 mt-5">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center">
            <button
              ...
              className="bg-red-600 text-white px-4 py-2 rounded-full shadow-lg focus:outline-none hover:bg-red-700 transition duration-200 z-50"
            >
              Emergency Contact
            </button>
          </div>
          ...
          <div className="-mr-2 flex md:hidden cursor-pointer">
            <button
              onClick={toggleMenu}
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-700"
      ...
      {isOpen && (
        <div className="absolute inset-0 z-20 bg-white flex flex-col items-center justify-center space-y-4">
      ...
      <div className="absolute top-3 left-1/2 transform -translate-x-1/2 md:hidden w-full flex justify-center z-50">
        <button
          onClick={toggleEmergencyDropdown}
          className="mb-10 bg-red-600 text-white px-2 py-2 rounded-full shadow-lg focus:outline-none hover:bg-red-700 transition duration-200"
        >
          Emergency Contact
        </button>
      </div>
      ...
      {showEmergencyDropdown && (
        <div className="fixed inset-0 flex justify-center items-center bg-gray-800 bg-opacity-50 z-50"> {/* Added z-50 */}
          <div className="bg-white rounded-lg p-4 z-50"> {/* Ensure dropdown stays on top */}
