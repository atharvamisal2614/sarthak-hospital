...
function Welcome() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-6 mt-4 md:mt-8">
      ...
      <h1 className="text-3xl font-bold text-blue-500 underline text-center mb-4 md:hidden">
      ...
      <div className="w-full md:w-1/2 mt-4 md:mt-0 md:ml-10">
        ...
        <h1 className="hidden md:block text-3xl font-bold text-blue-500 underline">
          Welcome to Sarthak Hospital
        </h1>
